...
happyExpList = HappyA# "\x10\x00\x40\x10\x60\x10\x40\x00\x00\x00"#
...
happyActOffsets = HappyA# "\x04\x00\x00\x00\xfe\xff\x04\x00\x01\x00\x04\x00\x03\x00\x00\x00\x00\x00"#

happyGotoOffsets :: HappyAddr
happyGotoOffsets = HappyA# "\x07\x00\x00\x00\x00\x00\x08\x00\x00\x00\x09\x00\x00\x00\x00\x00\x00\x00"#

happyAdjustOffset :: Happy_GHC_Exts.Int# -> Happy_GHC_Exts.Int#
happyAdjustOffset off = off

happyDefActions :: HappyAddr
happyDefActions = HappyA# "\xfe\xff\x00\x00\x00\x00\xfe\xff\x00\x00\xfe\xff\xfc\xff\xfd\xff"#

happyCheck :: HappyAddr
happyCheck = HappyA# "\xff\xff\x03\x00\x04\x00\x02\x00\x03\x00\x01\x00\x03\x00\x00\x00\x00\x00\x00\x00\xff\xff\xff\xff\xff\xff\xff\xff"#

happyTable :: HappyAddr
happyTable = HappyA# "\x00\x00\x06\x00\xff\xff\x08\x00\x06\x00\x04\x00\x06\x00\x02\x00\x04\x00\x06\x00\x00\x00\x00\x00\x00\x00\x00\x00"#
